...
import "swiper/css";
import "swiper/css/navigation"; // Importando os estilos da navegação
                ...
                <div className="relative w-full max-w3xl px-12">
                    ...
                    <SwiperSlide>
                        <Card className="w-full max-w-[40rem] shadow-lg bg-[#13131f] text-white">
                            <CardHeader floated={false}>
                                <img
                                src="https://i.imgur.com/F9Ut6xd.jpeg"
                            ...
                            <a href="https://livraria-sepia-ten.vercel.app/" target="_blank" rel="noopener noreferrer">
                    ...
                    <SwiperSlide>
                        <Card className="w-full max-w-[40rem] shadow-lg bg-[#13131f] text-white">
                            <CardHeader floated={false}>
                                <img
                                src="https://i.imgur.com/XTpUjkR.jpeg"
                                alt="ui/ux review check"
                                />
                                <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-tr from-transparent via-transparent to-black/60 " />
                            </CardHeader>
                            <CardBody>
                                <div className="flex items-center justify-between">
                                <Typography variant="h5" color="white" className="font-bold">
                                    Controle de Acesso aos Laboratório - IFTO
                                </Typography>
                                </div>
                                <div className="group inline-flex flex-wrap items-center gap-3">
                                ...
                                <Tooltip content="Django">
                                    <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="h-6 w-6">
                                        <svg fill="#3d9561" viewBox="0 0 128 128">
                            ...
                            <CardFooter className="pt-0">
                            <a href="https://github.com/Mateusinhodev/Labin-IFTO" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" fullWidth={true}>
                                Visitar
                                </Button>
                            </a>
                    ...
                    <SwiperSlide>
                        <Card className="w-full max-w-[40rem] shadow-lg bg-[#13131f] text-white">
                            <CardHeader floated={false}>
                                <img
                                src="https://i.imgur.com/HvcF00r.png"
                                alt="ui/ux review check"
                                />
                                <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-tr from-transparent via-transparent to-black/60 " />
                            </CardHeader>
                            <CardBody>
                                ...
                                <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                                    <svg viewBox="0 0 128 128" className="h-6 w-6" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <CardFooter className="pt-0">
                            <a href="https://facilgestao.netlify.app/login" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" fullWidth={true}>
                                Visitar
                                </Button>
                            </a>
